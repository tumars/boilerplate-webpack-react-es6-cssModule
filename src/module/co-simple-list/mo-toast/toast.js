...
class Toast extends Component {
    ...
    renderContent() {
        ...
        return (
            ...
            >
                { iconClass && <i className={this.classNames('tj-msg-icon', iconClass)}></i> }
                { !iconClass && type !== 'text' && <img className="tj-msg-img" src={icons[type]} /> }
                { this.props.content }
                { this.props.showClose && <div className="tj-msg-close tj-iconfont tj-icon-close" onClick={this.onClose.bind(this)}></div> }
            </div>
        )
    }
